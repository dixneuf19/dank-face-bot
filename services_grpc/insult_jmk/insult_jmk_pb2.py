...
_INSULTREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="insultJMK.InsultRequest.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_INSULTRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="insultJMK.InsultResponse.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
InsultRequest = _reflection.GeneratedProtocolMessageType(
    "InsultRequest",
    (_message.Message,),
    dict(
...
InsultResponse = _reflection.GeneratedProtocolMessageType(
    "InsultResponse",
    (_message.Message,),
    dict(
